...
// coX.innerHTML=window.sessionStorage.getItem(`score`)

// if(innerWinner=`palyer [ X ] winner`){
//   window.sessionStorage.setItem(`score`,++5);
//   coX.innerHTML=  window.sessionStorage.getItem(`score`);
// }
...
one.addEventListener(
  ...
  function () {
    ...
    transform: scale(1);
    display: flex;`;
        window.sessionStorage.setItem(`lol`, +coX.innerHTML + 5);
      }
      if (
...
coX.innerHTML = window.sessionStorage.getItem("lol");
